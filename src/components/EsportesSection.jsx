  ...
  const esportes = [
    {
      ...
      horario: 'Horário',
      time: '18:00 às 19:00 (Terças e Quintas)',
    },
    {
      imagem: jiuAdulto,
      ...
      horario: 'Horário',
      time: '10:00 (Iniciantes), 12:00 (Intermediário/Avançado), 19:00 (Iniciantes), 20:15 (Intermediário/Avançado), 22:00 (Iniciantes)',
    },
    {
      imagem: jiuBaby,
      ...
      horario: 'Horário',
      time: '18:15 às 19:00 (Segundas e Quartas)',
    },
    {
      imagem: kickboxer,
      titulo: 'KickBoxer',
      ...
      horario: 'Horário',
      time: '8:00 às 9:00, 17:30 às 18:30, 19:00 às 20:00 e 20:00 às 21:00',
    },
    {
      imagem: nogi,
      titulo: 'No-Gi',
    ...
    },
    {
      ...
      horario: 'Horário',
      time: '17:30 às 18:30 (Segundas e Quartas)',
    },
  ];
  ...
  return (
    <div className="container py-5">
      ...
      <div className="d-flex flex-wrap justify-content-center gap-4">
        {esportes.map((e, i) => (
          <div key={i} className="card esporte-card shadow-sm" style={{ width: '18rem' }}>
            <img
              src={e.imagem}
      ...
      >
        ...
        <Modal.Body className="text-center">
          ...
          />
          <p className="mt-3">{imagemExpandida?.descricao}</p>
          <p className="fs-5 fw-bold">{imagemExpandida?.horario}</p>
          <p>{imagemExpandida?.time}</p>
        </Modal.Body>
      </Modal>
    </div>
  );
